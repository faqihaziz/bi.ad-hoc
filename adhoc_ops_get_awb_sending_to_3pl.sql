-- Langkah2:
-- 1. Running Query dummy_sc_scan_record_urutan untuk mengambil history scan recordnya
-- 2. Running Query ini
...
SELECT
            ...
            WHERE DATE(currenttab.record_time,'Asia/Jakarta') BETWEEN '2024-03-02' AND '2024-03-08' 
